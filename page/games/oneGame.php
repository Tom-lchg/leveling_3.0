...
<div class="max-w-7xl mx-auto">
   ...
   <div class='h-[23rem] relative rounded-md'>
      ...
      <!-- Pseudo + Settings -->
      <div class='ml-[12em] top-60 relative z-10 justify-between flex text-2xl h-full text-white font-leger'>
            ...
            <div class='mb-8 flex h-full items-center pl-8'>
               <div class='flex gap-4 items-center ml-[17em]'>
                  <div class="flex justify-center items-center">
                     <!-- Note des users -->
                    <div class="bg-info rounded-full h-14 w-14 flex justify-center items-center text-white font-bold"><p><?= $game['gameAvis'] ?>/20</p></div>
                  ...
                  <div class="divider divider-horizontal text-neutral"></div>
                     <!-- Classification -->
                     <div class="bg-error rounded-full h-14 w-14 flex justify-center items-center text-white font-bold"><p>+<?= $game['gameClassification'] ?></p></div>
                        <p>Classification</p>
                    </div>
                     <!-- Classification -->
            </div>
    ...
    <div class='grid grid-cols-4 gap-6 mt-4 pb-4 h-auto'>
