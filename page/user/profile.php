...
<div class="col-start-1 col-end-2 container-home p-6">
   ...
   <div class="font-bold w-full flex justify-center items-center h-14 bg-neutral text-primary  rounded-md"><p>À PROPOS</p></div>
...
<div class="col-start-2 col-end-5">
   <!-- Tabs -->
   <div class="col-start-2 col-end-5 tabs tabs-boxed mb-4 h-10 bg-accent font-semibold">
   ...
   <div class='mt-4 mb-4'>
      <?php if (!isset($_GET['req'])) : ?>
         ...
         <div class="font-bold w-full flex justify-center items-center h-14 bg-neutral text-primary rounded-md"><p>ACTIVITÉ</p></div>
